void Plot_BDT_invertedADC(TString model = "my_model_1")
{
  TFile *f = new TFile(Form("root/%s_BDT_scores_invertedADC.root",model.Data()));
  ...
  c1->SaveAs(Form("img/%s_BDT_score_invertedADC.pdf",model.Data()));
